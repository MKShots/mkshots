...
I'm a former financial analyst turned data scientist, with a sharp eye for patterns and an obsession for tech that makes life smarter. I'm pursuing my Master's while working on real-world machine learning projects that blend intuition, analytics and critical reasoning. My projects blend business understanding with technical expertise to drive insights and impact.
...
* ⚙️ Currently exploring **Credit Risk Analysis**

---

### 🚀 Latest Projects

* 📉 **[Default Risk Rating Framework](https://github.com/MKShots/Default-Risk-Rating)**
Credit risk assessment using Altman Z-Score and Merton structural default models.
